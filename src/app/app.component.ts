...
export class AppComponent {
  ...
  form = this.fb.group({
    ...
    name: ['',
      [
        Validators.required,
        Validators.pattern(/[А-яЁё a-zA-Z]/g)]
    ],
    phone: ['',
      [
        Validators.required,
  ...
  productsData = [
    ...
    },
    {
      ...
      text: 'Булочка для бургера, две говяжьи котлеты, двойной сыр чеддер, огурец маринованный, криспи лук, кетчуп, соус сырный, горчица, зелень',
      price: 11,
      basePrice: 11,
      grams: 400
    },
    {
      image: "10.png",
      title: 'Фрешбургер',
      text: 'Булочка для бургера, говяжья котлета, бекон, сыр чеддeр, яйцо, салями, соус барбекю, соус сырный, салат айсберг, свежий томат',
      price: 9,
      basePrice: 9,
      grams: 300
    },
    ...
    },
    {
      ...
      text: 'Булочка для бургера, котлета говяжья, грудинка, красный лук, огурец маринованный, томат, кетчуп, двойной сыр чеддер, горчица, зелень',
      price: 9,
      basePrice: 9,
      grams: 360
    },
